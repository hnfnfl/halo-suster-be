CREATE TABLE medical_records IF NOT EXISTS(
  unique_id varchar(255) primary key,
  identity_number varchar(16) foreign key not null,
  creator_id varchar(255) foreign key,
...
CREATE INDEX IF NOT EXISTS medical_records_phone_number
	ON medical_records(phone_number);
